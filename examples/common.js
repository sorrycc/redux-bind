...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"antd","1":"normal"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createBind = __webpack_require__(180);
	...
	exports.createBind = _createBind2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetAttribute = __webpack_require__(184);
	
	var _utilsGetAttribute2 = _interopRequireDefault(_utilsGetAttribute);
	...
	function createBind() {
	  ...
	  return function (Component) {
	    ...
	    var WrappedComponent = (0, _reactRedux.connect)(mapStateToProps)(_react2['default'].createClass({
	      ...
	      shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
	        function filterProps(props) {
	          return _extends({}, props, {
	            'redux-bind': _defineProperty({}, id, props['redux-bind'][id])
	          });
	        }
	        return !(0, _deepEqual2['default'])(filterProps(nextProps), filterProps(this.props));
	      },
	      ...
	      render: function render() {
	        ...
	        var fieldProps = fields.reduce(function (memo, field) {
	          memo[field] = (0, _utilsGetAttribute2['default'])(_this.props['redux-bind'], id, field);
	          return memo;
	        }, {});
	        return _react2['default'].createElement(
	          Component,
	          _extends({}, fieldProps, this.props),
	          this.props.children
	        );
	      }
	    }));
...
/***/ function(module, exports) {
	...
	function getAttribute(state, id, property) {
...
/***/ function(module, exports) {
	...
	exports['default'] = function (state, action) {
	  ...
	  switch (type) {
	    case 'redux-bind':
	      var newProps = _extends({}, state[id] || {}, payload);
	      return _extends({}, state, _defineProperty({}, id, newProps));
	    default:
	      return state;
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function normalizeAction(action, getState) {
	  ...
	  return _extends({}, action, {
	    payload: (0, _utilsMapValues2['default'])(payload, function (item, key) {
	      if (typeof item === 'function') {
	        return item((0, _utilsGetAttribute2['default'])(getState()['redux-bind'], id, key));
	      } else {
	        return item;
	      }
	    })
	...
	function bindMiddleware(_ref) {
	  var getState = _ref.getState;
	
	  return function (next) {
	    return function (action) {
	      var actionModified = undefined;
