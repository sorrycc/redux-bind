...
/***/ function(module, exports, __webpack_require__) {
	...
	var _antdLibButton = __webpack_require__(188);
	
	var _antdLibButton2 = _interopRequireDefault(_antdLibButton);
	
	var _antdLibModal = __webpack_require__(192);
	
	var _antdLibModal2 = _interopRequireDefault(_antdLibModal);
	
	// app.js
	
	var FileUploadModal = (0, _srcIndex.createBind)({
	  id: 'modal.fileUpload',
	  fields: ['visible']
	...
	var App = (0, _reactRedux.connect)()(_react2['default'].createClass({
	  toggleModal: function toggleModal() {
	    this.props.dispatch({
	      type: 'redux-bind',
	      id: 'modal.fileUpload',
	      payload: { visible: function visible(v) {
	          return !v;
	        } }
	    });
	  },
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _antdLibButton2['default'],
	        { type: 'primary', onClick: this.toggleModal },
	        'Upload File'
	      ),
	      _react2['default'].createElement(
	        FileUploadModal,
	        { title: 'File Upload', onOk: this.toggleModal, onCancel: this.toggleModal },
	        '1111'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcDialog = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dialog = __webpack_require__(196);
